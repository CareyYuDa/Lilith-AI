...
EVENT_PATTERNS = [
    ...
    (r"(哈哈哈|哈哈|笑死|好好笑|有趣|搞笑|乐|太逗了|绝了|笑)",
     0.15, 0.25, 0.05, 0.6, "主人开心"),
    (r"!{2,}|！{2,}",
     0.05, 0.2, 0.0, 0.5, "主人兴奋"),
